...
import CST.Simple.Internal.CodegenError (CodegenError(..), NameError)
...
getNameError :: forall a m. MonadThrow Error m => ModuleBuilder a -> m NameError
getNameError mb = do
  e <- buildModuleErr mb
  requireMatch e $ case _ of
